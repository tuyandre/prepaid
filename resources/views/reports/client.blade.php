    ...
    <div class="info">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Customized Client Report</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
...
{{--                            <li class="breadcrumb-item active">Client Report</li>--}}
        ...
        <div class="content-register">
           <div class="card-title">
            ...
            <div class="item2">
                <form role="form" method="POST"  action="{{route('reports.customClientReport')}}" target="_blank" >
                    @csrf
    ...
    <div class="info">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Full Client Report</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
{{--                            <li class="breadcrumb-item"><a href="#">Home</a></li>--}}
{{--                            <li class="breadcrumb-item active">Client Report</li>--}}
        ...
        <div class="content-register">
            ...
            <div class="item2">
                <form role="form" method="POST"  action="{{route('reports.clientReport')}}" target="_blank" >
                    @csrf
                    <div class="message"></div>

                    <div class="info" >
                        <div class="step-title"><span>Full Client Report</span><hr></div>
{{--                        <div class="card-body">--}}
{{--                            <div class="form-group">--}}
{{--                                <label for="displayId">Starting Date </label>--}}
{{--                                <input type="date" class="form-control" id="date1" placeholder="date"  required name="date1" >--}}
...
{{--                            </div>--}}
                        ...
                        <div class="card-footer form-group">
                            ...
                            <input :disabled="is_disable" class="btn update btn-secondary" type="submit" value="Generate Report">
                        </div>
{{--                    </div>--}}
                </form>
            </div>
