                    ...
                    <div class="info" >
                        ...
                        <div class="card-body">
                               <div class="form-group">
                                ...
                                <!-- <input type="text" class="form-control" id="nameId" placeholder="Name" v-model="form.name" required name="name" :class="{ 'is-invalid': form.errors.has('name') }"> -->
                               <select v-model="form.name" class="form-control" required :class="{ 'is-invalid': form.errors.has('name') }">
     ...
     name:'addRole',
        ...
        methods: {
            submit(){
                ...
                this.form.post('/admin/AddRole/save')
                    .then(({ data }) => {
